  ...
  return (
    <BrowserWrapper news={true}>
      <BrowserContainer>
        <Newscard >
          <NewsCard>
            <img src="https://source.unsplash.com/892x119/?videogame,games" alt="" />
            <span>Edição Ultimate inclui Season Pass e muito mais</span>
          </NewsCard>
          <NewsCard>
            <img src="https://source.unsplash.com/892x119/?videogame" alt="" />
        ...
        <NewsWrapper>
          <RecentNews>
            ...
            <RecentNewsGrid>
              ...
              <FeaturedNewsCard>
                <img src="https://source.unsplash.com/430x197/?tech,games" alt="" />
                <div className="content">
                  <span>DESTAQUE</span>
